...
The binding package contract is [normative/package-contract.md](normative/package-contract.md), the validator evidence contract is [normative/validator-evidence-contract.md](normative/validator-evidence-contract.md), the sole-writer operation/replay contract is [normative/semantic-kernel-contract.md](normative/semantic-kernel-contract.md), the non-semantic Agent control-plane contract is [normative/control-plane-contract.md](normative/control-plane-contract.md), the default-deny policy/intake contract is [normative/core-processing-policy-contract.md](normative/core-processing-policy-contract.md), the descriptor-bound filesystem contract is [normative/vault-mutation-gate-contract.md](normative/vault-mutation-gate-contract.md), the specification-only deterministic corpus contract is [normative/reference-vault-generator-contract.md](normative/reference-vault-generator-contract.md), the isolated advisory proposal protocol is [normative/intelligence-adapter-protocol.md](normative/intelligence-adapter-protocol.md), and the independently claimable local profile is [normative/local-intelligence-adapter-profile.md](normative/local-intelligence-adapter-profile.md). Machine-readable requirements are indexed in [normative/requirements.json](normative/requirements.json), every product-domain term resolves to the repository [glossary](../../CONTEXT.md), and the eight isolated claim profiles are indexed in [claims-and-evidence.yaml](claims-and-evidence.yaml).
