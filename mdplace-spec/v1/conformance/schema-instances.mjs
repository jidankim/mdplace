...
export async function checkSchemaInstances(packageRoot, conformance) {
  ...
  const bindings = [
    ...
    ['contracts/transitions/codex-adapter-capability-proof-lifecycle.json', 'contracts/schemas/transition-table.schema.json'],
    ['contracts/transitions/codex-adapter-network-proof-lifecycle.json', 'contracts/schemas/transition-table.schema.json'],
    ['contracts/transitions/codex-adapter-authentication-prerequisite-lifecycle.json', 'contracts/schemas/transition-table.schema.json'],
    ['contracts/transitions/codex-adapter-proposal-validation-lifecycle.json', 'contracts/schemas/transition-table.schema.json'],
    ['contracts/transitions/codex-adapter-denial-lifecycle.json', 'contracts/schemas/transition-table.schema.json'],
    ['contracts/transitions/codex-adapter-failure-lifecycle.json', 'contracts/schemas/transition-table.schema.json'],
    ['contracts/transitions/codex-adapter-recovery-lifecycle.json', 'contracts/schemas/transition-table.schema.json'],
    ...
    ['conformance/evidence/invocations/codex-adapter-profile.json', 'contracts/schemas/validator-invocation.schema.json'],
    ['conformance/evidence/envelopes/codex-adapter-profile.json', 'contracts/schemas/evidence-envelope.schema.json'],
  ];
