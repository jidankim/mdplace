...
const denialSemantics = [
  ...
  ['trusted_attempt_accounting_and_retry_chain', 'policy.retry_exceeded'],
  ...
  ['destination_bound_retention_and_training_risk_acknowledgment', 'policy.retention_unproven'],
